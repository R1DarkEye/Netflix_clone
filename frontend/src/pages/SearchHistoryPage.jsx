    ...
    <div className='bg-black text-white min-h-screen'>
        ...
        <div className='max-w-6xl mx-auto px-4 py-8'>
            ...
            {searchHistory?.map((entry)=>(
                <div 
                key={entry.id} className='bg-gray-800 p-4 rounded flex items-start'>
                    <img src={SMALL_IMG_BASE_URL + entry.image} alt="histroy image" className='size-16 rounded-full object-cover mr-4'/>
