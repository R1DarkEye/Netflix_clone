    ...
    <div className='h-screen w-full hero-bg'>
      ...
      <div className='flex items-center justify-center mt-20 mx-3'>
        ...
        <div className='w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md'>
          ...
          <h1 className='text-2xl mb-4 text-white font-bold text-center'>Login</h1>
          ...
          <form className='space-y-4 ' onSubmit={handleLogin}>
            ...
            <div  className='text-gray-300 text-center'>Dont' have an account? <Link to='/signup' className='text-red-600'>SignUp</Link></div>
